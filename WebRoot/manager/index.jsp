  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			<span class="header-logo">在线考试系统管理页面</span> 
			<a class="header-menu-btn" href="javascript:;"><i class="icon-font">&#xe600;</i></a>
			<ul class="header-bar">
				<li class="header-bar-role"><a href="javascript:;">欢迎 超级管理员</a></li>
	...
	<script type="text/javascript" src="../manager/js/sccl.js"></script>
	<script type="text/javascript" src="../manager/js/sccl-util.js"></script>
  </body>
</html>
