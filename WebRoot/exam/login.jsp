  ...
  <body class="login-bg">
    <div class="login-box" style="height:auto;">
        ...
        <div class="login-main" style="height:auto;">
			<form action="LoginAction_doLogin" class="layui-form" method="post">
				<input name="__RequestVerificationToken" type="hidden" value="">                
				<div class="layui-form-item">
					<label class="login-icon">
						<i class="layui-icon"></i>
					</label>
					<input type="text" name="number" lay-verify="number" autocomplete="off" placeholder="这里输入登录名" class="layui-input">
				</div>
				<div class="layui-form-item">
					<label class="login-icon">
						<i class="layui-icon"></i>
					...
					<div style="color:#f00;font-size:14px;"><s:actionerror></s:actionerror></div>
				</div>
				
					<input type="radio" name="role" value="teacher" title="教师" checked="checked"/>
				...
				<div class="layui-form-item">
					...
					<div class="clear"></div>
					<div>还没注册？<a href="regStudent.jsp">去注册</a></div>
				</div>
			</form>        
		</div>
        <footer>
