  ...
  <head>
	...
	<script type="text/javascript"  src="../js/jquery-1.3.2.min.js" ></script>
	 ...
	 function isExist(number1){
			var url_check = "RegTeaAction_validateNum.action?number1="+number1;
			//alert("aaa");
			$.ajax({
			type: "POST",
			url: url_check,
  ...
  <body class="login-bg">
    <div class="login-box" style="height:auto;">
        ...
        <div class="login-main" style="height:auto;">
			<form action="RegTeaAction_doReg" class="layui-form" method="post">
				<input name="__RequestVerificationToken" type="hidden" value="">                
				<div class="layui-form-item">
					<label class="login-icon">
						<i class="layui-icon"></i>
					</label>
					<input type="text" name="number" lay-verify="number" autocomplete="off" placeholder="这里输入编号" class="layui-input" onblur="isExist(this.value)"><div class='availability_status'></div>
					<div style="color:#f00;font-size:12px;"><s:fielderror><s:param>number</s:param></s:fielderror></div>
				</div>
				<div class="layui-form-item">
					<label class="login-icon">
						<i class="layui-icon"></i>
