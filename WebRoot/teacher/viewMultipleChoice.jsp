  ...
  <body>
    <div>
    	<s:form action="SingleChoiceAction_saveOrUpdate" namespace="/" method="post">
    		...
    		<s:hidden name="id"/>
            <table>
              <tr><s:a action="MultipleChoiceAction_allMultipleChoice">返回</s:a></tr>
              <tr>
                <td><span>题号：&nbsp;&nbsp; </span></td>
              ...
              <tr>
                <td><span>选项E：&nbsp;&nbsp; </span></td>
                <td><s:textfield name="choicee" cssClass="text" readOnly="readOnly"/></td>
                <td><div style="color:#f00;font-size:12px;"><s:fielderror><s:param>choicee</s:param></s:fielderror></div></td>
              </tr>
              <tr>
                <td><span>选项F：&nbsp;&nbsp; </span></td>
                <td><s:textfield name="choicef" cssClass="text" readOnly="readOnly"/></td>
