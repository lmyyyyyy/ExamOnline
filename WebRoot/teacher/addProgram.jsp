...
th,td {     padding: .65em;   }   
  ...
  <body>
    <div>
    	<s:form action="ProgramAction_doAdd" namespace="/" method="post">
            <table>
           	  <tr>
                <td><span>题号：&nbsp;&nbsp; </span></td>
                <td><s:textfield name="number" value="%{bcNumber}" cssClass="text" readOnly="readOnly"/></td>
                <td><div style="color:#f00;font-size:12px;"><s:fielderror><s:param>number</s:param></s:fielderror></div></td>
              </tr>
              <tr>
                <td><span>问题：&nbsp;&nbsp; </span></td>
                <td><s:textarea name="question" cssClass="text" style="width:500px;height:200px;"/></td>
                <td><div style="color:#f00;font-size:12px;"><s:fielderror><s:param>question</s:param></s:fielderror></div></td>
              </tr>
              <tr>
                <td><span>答案： &nbsp;&nbsp; </span></td>
                <td><s:textarea name="answer" cssClass="text" style="width:500px;height:200px;" /></td>
