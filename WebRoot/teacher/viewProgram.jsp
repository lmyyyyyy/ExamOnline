...
td {     padding: .65em;   }
  ...
  <body>
    <div>
    	<s:form action="ProgramAction_saveOrUpdate" namespace="/" method="post">
    		<s:hidden name="sid"/>
    		<s:hidden name="id"/>
            <table>
              <tr><s:a action="ProgramAction_allProgram">返回</s:a></tr>
              <tr>
                <td><span>题号：&nbsp;&nbsp; </span></td>
              ...
              <tr>
                <td><span>问题： &nbsp;&nbsp; </span></td>
                <td><s:textarea name="question" cssClass="text"  readOnly="readOnly" style="width:500px;height:200px;"/></td>
                <td><div style="color:#f00;font-size:12px;"><s:fielderror><s:param>question</s:param></s:fielderror></div></td>
              </tr>
              
              <tr>
                <td><span>答案：&nbsp;&nbsp; </span></td>
                <td><s:textarea name="answer" cssClass="text" readOnly="readOnly" style="width:500px;height:200px;"/></td>
