...
<html>
  <head>
	...
	<script type="text/javascript"  src="js/jquery-1.3.2.min.js" ></script>
	 ...
	 function change(){
			var bianchengfen = document.getElementById("programCount").value * document.getElementById("programScore").value;
			var bianchengcount = document.getElementById("programCount").value;
			var zongfen = bianchengfen;
			if (bianchengcount > 5) {
				 alert("编程数量不能超过5道","系统提示");
				 document.getElementById("programCount").value = 3;
			 } else {
				 if(zongfen != 90)
	             {
	                 alert("系统总分不是90分了","系统提示");
	 ...
	 $(function(){
             var bianchengfen=$("#programCount").val()*$("#programScore").val();
            
             $("#totalScore").val(bianchengfen);
...
th,td {     padding: .65em;   }   
  ...
  <body>
    <div>
    	<s:form action="PaperAction_doAddProgram" namespace="/" method="post">
            ...
            <tbody>
              ...
              <tr>
                <td><span>编程数量：&nbsp;&nbsp; </span></td>
                <td><s:textfield name="programCount" id="programCount" cssClass="text" value="3" onblur="change()"/>(<=5)</td>
                <td><div style="color:#f00;font-size:12px;"><s:fielderror><s:param>programCount</s:param></s:fielderror></div></td>
              </tr>
               <tr>
                <td><span>编程分数：&nbsp;&nbsp; </span></td>
                <td><s:textfield name="programScore"  id="programScore" cssClass="text" value="30" onblur="change()"/></td>
                <td><div style="color:#f00;font-size:12px;"><s:fielderror><s:param>programScore</s:param></s:fielderror></div></td>
              </tr>
              <tr>
                <td><span>总分数：&nbsp;&nbsp; </span></td>
