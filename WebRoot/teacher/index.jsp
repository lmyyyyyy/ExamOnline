  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			<span class="header-logo">在线考试系统教师管理页面</span> 
			<a class="header-menu-btn" href="javascript:;"><i class="icon-font">&#xe600;</i></a>
			<ul class="header-bar">
				<li class="header-bar-role"><a href="javascript:;">欢迎教师</a></li>
		...
		<i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
					<ul class="header-dropdown-menu">
						<li><a href="../exam/logout.jsp">切换账户</a></li>
						<li><a href="../exam/logout.jsp">退出</a></li>
					</ul>
				</li>
				<li class="header-bar-nav"> 
		...
		<section class="layout-main">
			...
			<div class="layout-main-body">
				<iframe class="body-iframe" name="iframe0" width="100%" height="99%" src="home.jsp" frameborder="0" data-id="home.html" seamless></iframe>
			</div>
		</section>
		<div class="layout-footer">@2018 GUOLINLIN</div>
	</div>
	<script type="text/javascript" src="../common/lib/jquery-1.9.0.min.js"></script>
	<script type="text/javascript" src="../teacher/js/sccl.js"></script>
	<script type="text/javascript" src="../teacher/js/sccl-util.js"></script>
  </body>
</html>
